 ...
 * -XX:-UseBiasedLocking
 */
public class JUCLockBench extends BenchWorker {
    public static long value = 20000000;
    private static Lock lock = new ReentrantLock();
    private static int count;

    public JUCLockBench(CyclicBarrier barrier) {
        super(barrier);
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        benchExecutor.benchMark(new JUCLockBench(benchExecutor.getCyclicBarrier()));
    }
